...
variable "aws_region1" {
  ...
  default     = "eu-west-2" # us-west-2, eu-west-2
}
...
variable "aws_az1" {
  type        = string
  description = "AWS AZ"
  default     = "eu-west-2a" # us-west-2a, eu-west-2a
}
variable "aws_az2" {
  type        = string
  description = "AWS AZ"
...
variable "ec2_ami1" {
  default = "ami-0fb391cce7a602d1f" # Ubuntu 22.04 in aws_region1 (us-west-2 ami-0d70546e43a941d70, eu-west-2 ami-0fb391cce7a602d1f)
}
variable "ec2_ami2" {
...
variable "pf_crc_pop1" {
  type    = string
  default = "LON1" # PDX2/a LAX1/c SF06/a LON1/a
}
